...
from decouple_vulkan_rendertarget_depthstate import decouple as decouple_vulkan_rendertarget_depthstate
...
def harden(root: Path) -> None:
    ...
    decouple_vulkan_rendertarget_depthstate(root)
    print("[vulkan-capability] runtime + render core + SPIR-V pipeline + resources + renderer-neutral sun math + render-target formats/topology/depth state installed")
