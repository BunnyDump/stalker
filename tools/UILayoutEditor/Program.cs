    ...
    static class Program {
        [STAThread] static int Main(string[] args){
            try {
                ...
                Application.ThreadException+=delegate(object s,System.Threading.ThreadExceptionEventArgs e){MessageBox.Show(e.Exception.Message,"Ошибка редактора",MessageBoxButtons.OK,MessageBoxIcon.Warning);};
